...
<body class="childrenBody">
		...
		<form class="layui-form">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" id="hostname" value="" placeholder="请输入商户名"
						   class="layui-input search_input ">
				</div>
				<div class="layui-input-inline">
					<input type="text" id="agentname" value="" placeholder="请输入代理商名称"
						   class="layui-input search_input ">
				</div>
	...
	<div class="layui-form">
		<table id="shopperList" lay-filter="shopperList"></table>
	</div>
	...
	<script type="text/javascript" src="${ctx }/jsp/second/shopperList.js"></script>
</body>
